...
import { forgotPasswordSchema, password, putMessageSchema, putUserSchema } from '../schemas/put';
...
router.put('/forgot-password', validator(forgotPasswordSchema), forgotPassword);
